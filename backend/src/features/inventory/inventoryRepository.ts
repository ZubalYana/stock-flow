...
export const inventoryRepository = {
    ...
    async update(client: Prisma.TransactionClient, itemId: string, warehouseId: string, data: InventoryDTO){
        return await client.inventory.update({where: {warehouseId_itemId: {warehouseId, itemId}}, data: {quantity: data.quantity}})
    },
    async delete(client: Prisma.TransactionClient, itemId: string, warehouseId: string){
        return await client.inventory.delete({where: {warehouseId_itemId: {warehouseId, itemId}}})
    },
    async getAllByWarehouse(client: Prisma.TransactionClient, warehouseId: string){
